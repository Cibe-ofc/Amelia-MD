...
global.author = 'ikyofc' //ganti aja cuyyy
global.namebot = '​Iky-Md' //nama bot luh
global.wm = '© Iky-Md' //ganti aja
global.media = 'https://telegra.ph/file/5d45a3d1e12726d98c5e4.jpg' //bebas
global.wm = 'Iky-Md ' //wm nyaa kocak
global.watermark = wm //bebas
global.wm2 = 'Ikymd' //ganti ajaa 
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`//ga usah dehhh 
global.bottime = `T I M E : ${wktuwib}` //ini juga ga usah 
global.titlebot = `Ikymd | ikymd` //gantu aja
global.stickpack = 'ikymd' //ganti 
global.stickauth = `© ikymd` //gantii 
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= 'ikymd' //ganti 
global.nameown2 = 'ikymd' //ganti 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.Linkgc = 'Tunggu Sebentar Kak...'
global.lynk = 'https://chat.whatsapp.com/Fe2ky3uDJIdIvmtt41cO9h' jadi link gc luh
